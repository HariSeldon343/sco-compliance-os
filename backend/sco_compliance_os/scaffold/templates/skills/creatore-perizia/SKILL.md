---
name: creatore-perizia
description: "Crea perizie tecniche e relazioni di consulenza tecnica in piena forma peritale (frontespizio, indice con numeri di pagina, premessa e quesito, documentazione esaminata, accertamenti, conclusioni con risposta al quesito, riferimenti normativi), nello stile di Antonio Amodeo. Multi-dominio: cybersecurity, digital forensics, compliance e GDPR, sanita, antincendio, qualita, sicurezza sul lavoro. Supporta la modalita white-label, ossia documento a firma del cliente o committente senza alcun riferimento a SCO, Amodeo o Fortibyte nel testo e nei metadati. Usa SEMPRE quando l'utente chiede di redigere una perizia, una relazione peritale, una relazione di consulenza tecnica (di parte o simil-CTU), una nota tecnico-difensiva strutturata, oppure di mettere un contenuto in forma di perizia. Triggera anche per: scrivi una perizia, perizia tecnica, relazione peritale, relazione di consulenza tecnica, perizia di parte, consulenza tecnica di parte, CTP, perizia forense, metti in forma di perizia, creatore perizia, /perizia."
---

# Skill: creatore-perizia

## Scopo

Produrre perizie tecniche e relazioni di consulenza tecnica in piena forma peritale, nello stile di Antonio Amodeo, su qualsiasi dominio tecnico in cui opera: cybersecurity, digital forensics, compliance e protezione dati, sanita, prevenzione incendi, qualita, sicurezza sul lavoro. Supporta la modalita white-label: il documento esce a firma del cliente o committente, senza alcun riferimento al consulente reale (SCO, Amodeo, Fortibyte) ne nel testo ne nei metadati del file.

Non e una skill di dominio: non contiene conoscenza normativa specifica. Per i contenuti tecnico-normativi si appoggia alle skill di dominio (cybernis, qualita-sanita, iso42001, risk-manager, rivelazione-incendi, ecc.) e per lo stile ad amodeo-voice.
...
## Stile (richiama amodeo-voice)

- Registro formale, terza persona impersonale, periodi controllati, evidenza prima dell'opinione, pragmatismo, coraggio nelle conclusioni. Caricare [[Contesto/tono-di-voce]] e la skill [[Skill/amodeo-voice]].
...
- A chiusura: sempre /humanizer; per i testi normativi /disaiizzatore-normativo con report a parte.
...
- [[Contesto/tono-di-voce]] e [[Skill/amodeo-voice]] per lo stile
- [[Skill/disaiizzatore-normativo]] e [[Skill/humanizer]] per la pulizia anti-AI
- [[Skill/docx]] per la produzione Word, [[Skill/docx-style-cloner]] per la clonazione di carta intestata
- Skill di dominio per i contenuti tecnico-normativi: [[Skill/cybernis-sgsi-agent]], [[Skill/qualita-sanita-agent]], [[Skill/iso42001-integrato]], [[Skill/risk-manager-agent]], [[Skill/rivelazione-incendi-agent]]

## Link correlati

- [[Skill/amodeo-voice]]
- [[Skill/disaiizzatore-normativo]]
- [[Skill/docx]]
- [[Skill/docx-style-cloner]]
