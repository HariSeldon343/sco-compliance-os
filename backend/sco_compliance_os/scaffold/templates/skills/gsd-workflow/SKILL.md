...
Applicare la metodologia GSD ("Get Shit Done") come cornice operativa standard a ogni cantiere non banale del vault. GSD e una metodologia a fasi nata per agenti di sviluppo (repo originale gsd-build/get-shit-done, ora open-gsd/get-shit-done-redux) e qui adattata al lavoro consulenziale, documentale e di sviluppo di Antonio. Non sostituisce le regole permanenti del vault: le orchestra in un ciclo ripetibile.
