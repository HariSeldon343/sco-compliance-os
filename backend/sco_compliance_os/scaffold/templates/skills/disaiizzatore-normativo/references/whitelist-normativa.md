...
Lista di elementi testuali che la skill `disaiizzatore-normativo` **non deve mai modificare, parafrasare, riformulare o "umanizzare"**, anche quando appaiono dentro paragrafi che vengono altrimenti riscritti. Questi elementi sono inviolabili perché alterarli può:
