...
Questo file mostra il flusso completo di utilizzo della skill `docx-style-cloner` su un caso reale.

## Scenario

Antonio ha un documento `relazione_audit_27001_clienteX.docx` che gli piace come stile editoriale: Calibri 11pt, header con logo aziendale Fortibyte, footer con numerazione di pagina e codice documento, gerarchia titoli su tre livelli, citazioni in corsivo. Vuole produrre una nuova relazione di audit per un cliente diverso, con lo stesso identico aspetto ma contenuto diverso.
...
```json
{
  ...
  "sections": [{
    ...
    "header": {
      "text": "Fortibyte | Relazione di audit ISO/IEC 27001:2022",
      "paragraphs": ["Fortibyte | Relazione di audit ISO/IEC 27001:2022"],
      "images": [{"rId": "rId7"}]
    },
    "footer": {
...
- Header: "Fortibyte | Relazione di audit ISO/IEC 27001:2022" + immagine logo
...
- `Auditor lead: [nome]` → `Auditor lead: Antonio Silvestro Amodeo`
...
```json
{
  "blocks": [
    ...
    {"type": "paragraph", "text": "Auditor lead: Antonio Silvestro Amodeo"},
...
python scripts/clone_document.py \
  ...
  --placeholders '{"Cliente X S.r.l.":"Cliente Y S.p.A.", "15/01/2026":"26/04/2026", "Auditor lead: [nome]":"Auditor lead: Antonio Silvestro Amodeo"}'
```
...
- Header: logo Fortibyte + testo originale ✓
