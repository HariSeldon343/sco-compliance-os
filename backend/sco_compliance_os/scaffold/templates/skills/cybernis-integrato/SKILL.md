...
|------------------|-----------------|-----------------|
| `cybernis-sgsi-agent` | ISO/IEC 27001+27017+27018, GDPR, AI Act, Legge 132/2025, procedure CSQA (RVE, PDV, PAC, PDA, DDV, RCD, PVV), audit di terza parte come RGV CSQA | Quesito puramente SGSI/cloud/audit-CSQA, nessun riferimento a servizio gestito o obbligo NIS2 |
| `ism-cybernis-agent` | ISO/IEC 20000-1:2018 (clausole 4–10, gruppi 8.2–8.7), ITSM/ITIL, CMDB, SLA/OLA/UC, KEDB, integrazione SMS+SGSI+NIS2 in chiave operativa | Quesito puramente SMS/ITSM monotematico (es. solo CMDB, solo CAB, solo catalogo servizi) |
| `cybernis-integrato` (questa) | **Solo intersezioni vere** tra due o tre framework, deliverable consolidati, decisione di routing | Almeno due framework simultaneamente coinvolti nel deliverable |
...
|----------------------------|-------------------|
| Audit di terza parte CSQA, documenti RVE/PDV/PAC/PDA, Stage 1/Stage 2/Sorveglianza/Rinnovo, mappatura 27001/27017/27018, AI Act, Legge 132/2025 | `cybernis-sgsi-agent` |
| Estensioni cloud ISO/IEC 27017:2015 e ISO/IEC 27018:2019 (controlli CLD.x.x) anche se combinate con 27001 | `cybernis-sgsi-agent` |
| Adempimenti GDPR puri (DPIA, registro trattamenti, informative, nomine, valutazione legittimo interesse) senza intersezione con SGSI/SMS/NIS2 | `cybernis-sgsi-agent` |
| Adempimenti AI Act (Reg. (UE) 2024/1689) e Legge 132/2025 puri (classificazione sistemi IA, conformità, trasparenza) senza intersezione con SGSI/SMS/NIS2 | `cybernis-sgsi-agent` |
| Riesame della direzione monotematico SGSI (solo cl. 9.3 ISO/IEC 27001:2022) | `cybernis-sgsi-agent` |
| Riesame della direzione monotematico SMS (solo cl. 9.3 ISO/IEC 20000-1:2018) | `ism-cybernis-agent` |
| Processi 20000-1 monotematici (CMDB, CAB, RFC, KEDB, catalogo servizi, SLA/OLA/UC, dashboard KPI servizio) | `ism-cybernis-agent` |
| Obblighi NIS2 puri senza correlazione a SGSI/SMS (registrazione ACN, notifica CSIRT in isolamento) | `ism-cybernis-agent` (sezione CyberNIS) |
...
Riuso del pattern a 5 fasi di `cybernis-sgsi-agent`, applicato all'intersezione cross-framework. Il processo è interno: l'utente riceve solo l'output finale.
